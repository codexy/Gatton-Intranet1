...
If fs.FileExists("d:\inetpub\wwwroot\GSVitas\" & NAME) = true Then 
fs.DeleteFile("D:\inetpub\wwwroot\GSVitas\"& Name)
set fs=nothing
End If
%><table width="700" border="0" cellpadding="5" cellspacing="0">
  <tr>
    <td align="left">
      <p class="PageHeader">Graduate Student Web Vita Tools</p>      
  <%
...
%>
  ...
  <tr><td align="center" class="AllCapsTitle10">
    <p>&nbsp;</p>
    <p><a href="GSVita.asp">Go back to the vita page</a></p>
  </td>
  </tr>
</table></td>
  </tr>
