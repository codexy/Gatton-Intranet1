...
%>
<% If MemberInfo.Fields.Item("Position").Value = "Graduate Student" OR MemberInfo.Fields.Item("memberid").Value = 22 OR MemberInfo.Fields.Item("memberid").Value = 1114 Then
%>
<table width="700" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="20" valign="top" class="PageHeader"><p>Graduate Student Web Vita  Tools</p>
...
If (fs.FileExists("d:\inetpub\wwwroot\GSVitas\" & (MemberInfo.Fields.Item("lname").Value) & Left(MemberInfo.Fields.Item("fname").Value,1) & ".pdf") = true) Then 
  VitaOnFile = 2
End If
...
Set fs=Server.CreateObject("Scripting.FileSystemObject")
If (fs.FileExists("d:\inetpub\wwwroot\GSVitas\" & (MemberInfo.Fields.Item("lname").Value) & Left(MemberInfo.Fields.Item("fname").Value,1) & ".pdf") = true) Then %> 
  <p class="AllCapsTitle10"><a href="GSVitaDeleteConfirm.asp">Remove the Vita Currently on File</a></p>
  <% End If %>
...
%>
  ...
  <% End If %>
  <form action="GSVitaUpload.php" method="post" enctype="multipart/form-data" name="form1">
    <table border="0" align="center" cellpadding="3" cellspacing="3">
      <tr>
        <td class="BodyText"><strong class="AllCapsTitle">Vita: </strong></td>
        <td class="BodyText"><p>
  ...
  <tr><td><p align="center" class="PageHeaderBlack">OR</p>
    ...
    <form id="form2" name="form2" method="post" action="GSRecordVitaURL.asp">
      <table border="0" align="center" cellpadding="3" cellspacing="3">
        <tr>
          <td align="right" class="AllCapsTitle"><input name="VitaOther" type="radio" id="VitaOther" value="0" <% If MemberInfo.fields("VitaOther").Value = 1 Then %> 
              <% End If %>
              /></td>
          <td class="BodyText">I to remove my link to another URL in sharing my vita.</td>
          </tr>
        <tr>
...
<p class="AllCapsTitle">This vita tool is for Graduate Students only.</p>
<% End If %></td>
  </tr>
</table>
<%
